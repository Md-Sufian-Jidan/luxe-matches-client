  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="max-w-5xl mx-auto bg-bg-soft p-8 rounded-2xl shadow-lg font-body"
      >
        <div className="flex flex-col md:flex-row gap-8">
          <img
            src={bioData?.photoURL}
            alt="Profile"
            className="w-40 h-40 rounded-full object-cover self-center shadow-sm"
          />
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-text-main">
            {[
        ...
        {!bioData?.bioData.isPremium && (
          <div className="text-right mt-10">
            <motion.button
              ...
              className="bg-btn text-white px-6 py-2.5 rounded-2xl shadow-md hover:shadow-lg transition-all duration-200"
            >
        ...
        {bioData?.bioData.isPremium && (
          <p className="mt-8 flex items-center gap-2 text-emerald-600 font-semibold text-sm">
          ...
          <>
            ...
            >
              <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl p-6">
                <h2 className="text-xl font-heading text-text-main mb-3">
                  Upgrade to Premium?
                </h2>
                ...
                {requestSent ? (
                  <div>
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded border text-sm text-text-secondary hover:bg-bg-soft transition"
                    >
                      Close
                    </button>
                  </div>
                  ...
                  <div className="flex justify-end gap-4 mt-6">
                    ...
                    <button
                      ...
                      className="px-5 py-2 rounded bg-btn text-white hover:bg-primary transition disabled:opacity-60"
                    >
